# evil bugs not frogs
pa = particle accelerate
1. ~Dirt places grass~
2. ~You can place blocks on the player~
...
5. ~If you leave the world it enters a pa and you crash game~
...
13. Issues caused by smaller screen sizes such as asa being able to crash the game by dragging 
